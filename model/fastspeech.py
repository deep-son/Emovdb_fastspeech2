...
class TFFastSpeechDecoder(TFFastSpeechEncoder):
    ...
    def __init__(self, config, **kwargs):
        ...
        if config.n_speakers > 1:
            ...
            self.decoder_emotino_embeddings = TFEmbedding(
                config.n_emotions,
                config.hidden_size,
                embeddings_initializer=get_initializer(config.initializer_range),
                name="emotion_embeddings",
    ...
    def call(self, inputs, training=False):
        hidden_states, speaker_ids,emotion_ids, encoder_mask, decoder_pos = inputs
...
class TFFastSpeech(tf.keras.Model):
    ...
    def _build(self):
        ...
        self(input_ids, speaker_ids,emotion_ids, duration_gts)
    ...
    def call(
        self, input_ids, speaker_ids,emotion_ids, duration_gts, training=False, **kwargs,
    ):
        """Call logic."""
    ...
    def _inference(self, input_ids, speaker_ids,emotion_ids, speed_ratios, **kwargs):
        """Call logic."""
        attention_mask = tf.math.not_equal(input_ids, 0)
