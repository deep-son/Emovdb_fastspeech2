...
class CharactorDurationF0EnergyMelDataset(AbstractDataset):
    ...
    def __init__(
        ...
        self.emotions = [self.emotions_map[i.split("_")[1]] for i in self.utt_ids]
        print("Emotion: utt_id", list(zip(self.emotions, self.utt_ids)))
