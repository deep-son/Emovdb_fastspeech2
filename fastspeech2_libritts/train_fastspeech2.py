...
from fastspeech2_dataset import (
...
def main():
    ...
    parser.add_argument(
        "--train-dir",
        default="dump_libritts/train",
        type=str,
        help="directory including training data. ",
    )
    parser.add_argument(
        "--dev-dir",
        default="dump_libritts/valid",
        type=str,
    ...
    parser.add_argument(
        "--f0-stat", default="./dump_libritts/stats_f0.npy", type=str, help="f0-stat path.",
    )
    parser.add_argument(
        "--energy-stat",
        default="./dump_libritts/stats_energy.npy",
        type=str,
    ...
    parser.add_argument(
        "--dataset_config", default="/content/TensorFlowTTS/preprocess/libritts_preprocess.yaml", type=str,
    )
    parser.add_argument(
        "--dataset_stats", default="/content/drive/MyDrive/dump_emovdb/stats.npy", type=str,
    )
    parser.add_argument(
        "--dataset_mapping", default="/content/drive/MyDrive/dump_emovdb/libritts_mapper.json", type=str,
    )
    parser.add_argument(
        "--pretrained",
        default="",
    ...
    with open(args.dataset_mapping) as f:
        ...
        emotions_map = dataset_mapping["emotions_map"]
    ...
    n_emotions = config["fastspeech2_params"]["n_emotions"]
    assert n_emotions == len(
        emotions_map
    ), f"Number of emotion in dataset does not match n_emotions in config"
